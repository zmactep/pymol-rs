...
impl From<patinae_algos::dss::SsType> for SecondaryStructure {
    fn from(ss: patinae_algos::dss::SsType) -> Self {
        use patinae_algos::dss::SsType;
        match ss {
...
mod tests {
    ...
    fn test_secondary_structure_from_char() {
        ...
        assert_eq!(
            SecondaryStructure::from_char('S'),
        ...
        assert_eq!(
            SecondaryStructure::from_char('G'),
