...
/// Covalent radii: Cordero et al., Dalton Trans. 2832-2838, 2008.
...
/// Default covalent radius for unknown/superheavy elements
pub const DEFAULT_COV_RADIUS: f32 = 1.50;
...
impl Element {
    ...
    /// Get the covalent radius in Angstroms (Cordero et al. 2008)
    #[inline]
    pub fn cov_radius(&self) -> f32 {
        ELEMENT_DATA[*self as usize].cov
    }
