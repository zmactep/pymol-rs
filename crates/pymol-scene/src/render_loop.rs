...
impl Viewer {
    ...
    pub fn capture_png(
        ...
        let original_aspect = self.camera.aspect();
        self.camera.set_aspect(output_width as f32 / output_height as f32);
        ...
        self.camera.set_aspect(original_aspect);
