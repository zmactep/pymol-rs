...
impl SpatialHash {
    ...
    pub fn new(positions: &[[f32; 3]], radii: &[f32], min: [f32; 3], max: [f32; 3]) -> Self {
    ...
    pub fn query(&self, point: [f32; 3]) -> &[usize] {
        ...
        let cell_idx =
            x as usize + y as usize * self.dims[0] + z as usize * self.dims[0] * self.dims[1];
        &self.cells[cell_idx]
    }
...
mod tests {
    ...
    fn test_grid_creation() {
        let grid = Grid3D::from_bounds([0.0, 0.0, 0.0], [10.0, 10.0, 10.0], 1.0, 2.0);
    ...
    fn test_vertex_position() {
        let grid = Grid3D::from_bounds([0.0, 0.0, 0.0], [10.0, 10.0, 10.0], 0.5, 1.0);
    ...
    fn test_spatial_hash() {
        let positions = vec![[0.0, 0.0, 0.0], [5.0, 5.0, 5.0], [10.0, 10.0, 10.0]];
