...
mod tests {
    ...
    fn test_orthogonal_cell() {
        ...
        let cell = CrystalCell::new(Vec3::new(10.0, 20.0, 30.0), Vec3::new(90.0, 90.0, 90.0));
    ...
    fn test_monoclinic_cell() {
        ...
        let cell = CrystalCell::new(Vec3::new(10.0, 20.0, 30.0), Vec3::new(90.0, 100.0, 90.0));
