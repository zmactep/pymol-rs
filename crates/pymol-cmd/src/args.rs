...
/// Argument definition for command validation
#[derive(Debug, Clone)]
pub struct ArgDef {
    /// Argument name (for documentation and named args)
    pub name: String,
    /// Argument type
...
impl ArgDef {
    ...
    pub fn required_str(name: impl Into<String>, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
    ...
    pub fn optional_str(
        ...
        Self {
            ...
            arg_type: ArgType::String,
            required: false,
            default: Some(ArgValue::String(default.into())),
            help: help.into(),
        }
    }

    /// Create a required selection argument
    pub fn required_selection(name: impl Into<String>, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
            arg_type: ArgType::Selection,
            required: true,
            default: None,
            help: help.into(),
        }
    ...
    /// Create an optional selection argument with default "all"
    pub fn optional_selection(name: impl Into<String>, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
            arg_type: ArgType::Selection,
            required: false,
            default: Some(ArgValue::String("all".to_string())),
            help: help.into(),
        }
    }

    /// Create a required integer argument
    pub fn required_int(name: impl Into<String>, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
    ...
    /// Create an optional integer argument with default
    pub fn optional_int(name: impl Into<String>, default: i64, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
            arg_type: ArgType::Int,
            required: false,
    ...
    /// Create a required float argument
    pub fn required_float(name: impl Into<String>, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
    ...
    /// Create an optional float argument with default
    pub fn optional_float(name: impl Into<String>, default: f64, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
            arg_type: ArgType::Float,
            required: false,
            default: Some(ArgValue::Float(default)),
            help: help.into(),
        }
    }

    /// Create an optional boolean argument with default
    pub fn optional_bool(name: impl Into<String>, default: bool, help: impl Into<String>) -> Self {
        Self {
            name: name.into(),
            arg_type: ArgType::Bool,
            required: false,
            default: Some(ArgValue::Bool(default)),
            help: help.into(),
        }
    }
}
...
pub enum ArgType {
    ...
    /// Color name or RGB
    Color,
    /// Representation name (cartoon, sticks, etc.)
    Representation,
    /// Setting name
    Setting,
}
