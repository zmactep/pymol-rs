...
pub use command::{ArgHint, Command, CommandContext, CommandRegistry, FileHandler, MessageKind, OutputMessage, ViewerLike};
...
pub mod prelude {
    ...
    pub use crate::command::{ArgHint, Command, CommandContext, CommandRegistry, FileHandler, MessageKind, OutputMessage, ViewerLike};
